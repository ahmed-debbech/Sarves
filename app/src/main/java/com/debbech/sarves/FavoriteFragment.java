...
public class FavoriteFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("users", getActivity().MODE_PRIVATE);
        Map<String, String> us = (Map<String, String>) sharedPreferences.getAll();
        ArrayList<Contact> listcont = new ArrayList<Contact>();
        for(Map.Entry<String, String> entry : us.entrySet()){
            listcont.add(new Contact(entry.getValue(), entry.getKey()));
        }
        ...
        adapter = new ContactsAdapter(getContext(), listcont, ss);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //work
        contacts = (RecyclerView) getView().findViewById(R.id.list_fav);
